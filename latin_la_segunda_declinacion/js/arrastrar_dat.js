/*
arrastrar_dat.js
Arrastrar y soltar dativos de latin, 2a decl. 
Drag and drop latin dative words, 2. decl.
Author: Kari Lajunen 
*/
          ...
          function highlightWordEndings(list)
          {
            ...
            if (elements.length > 0)
            {
              ...
              if (elements[0].innerHTML.slice(-1) == "o" && elements.length == 2)
              { // -o
          ...
          function drop_1(ev)
          {
              ...
              if ( target_x ) 
              {
                  ...
                  var datives_1_ul = document.getElementById('datives_1');
                  var datives_2_ul = document.getElementById('datives_2');

                  console.log("data_text_content = " + data_text_content);

                  // Let's add the copy of the node (word) into the datives_1 list 
                  // if it is empty 
                  if ( datives_1_ul.getElementsByTagName('li').length == 0 ) 
                  {

                    // and if there is no similar words (endings) in other lists.
                    if ( ( datives_2_ul.getElementsByTagName('li').length == 0 || 
                      datives_2_ul.firstElementChild.innerHTML.slice(-1) != 
                      data_text_content.slice(-1) ) )
                    {
                      ...
                      // list called e.g. "datives_1". 
                      var li_node = document.createElement("LI");  
                      var textnode = document.createTextNode(data_text_content);
                      li_node.appendChild(textnode);
                      // Let's add the created new li_node to the ul list which id is e.g. "datives".
                      datives_1_ul.appendChild(li_node);
                  ...
                  { // There are already items in the datives_ul_1 list

                    var first_word = datives_1_ul.firstElementChild.innerHTML;
                    ...
                    if ( first_word.slice(-1) == data_text_content.slice(-1) )
                    {
                      ...
                      console.log("datives_1_ul.length = " + datives_1_ul.length);
                  ...
                  highlightWordEndings(datives_1_ul);
          ...
          function drop_2(ev)
          {
              ...
              if ( target_x ) 
              {
                  ...
                  // Let's add the copy of the node (word) into the datives_2 list 
                  // if it is empty 
                  if ( datives_2_ul.getElementsByTagName('li').length == 0 ) 
                  {
                    ...
                    // and if there is no similar words (endings) in other lists.
                    if ( ( datives_1_ul.getElementsByTagName('li').length == 0 || 
                      datives_1_ul.firstElementChild.innerHTML.slice(-1) != 
                      data_text_content.slice(-1) ) )
                    {
                      console.log("--- if block...")
                      ...
                      li_node.appendChild(textnode);
                      // Let's add the created new li_node to the ul list which id is e.g. "datives".
                      datives_2_ul.appendChild(li_node);
                  ...
                  { // There are already items in the datives_ul_2 list

                    var first_word = datives_2_ul.firstElementChild.innerHTML;
                    console.log("first_word: " + first_word);
                ...
                highlightWordEndings(datives_2_ul);
